...
export const MOCK_POST_DETAIL = {
  1: {
    ...
    sns_ig: "",
    sns_etc: "https://open.kakao.com/o/sOmElinK",
    tags: ["2016년", "xx초등학교", "짝꿍"],
    clues: [
  ...
  2: {
    ...
    sns_ig: "https://instagram.com/nasa",
    sns_etc: "",
    tags: ["제주도", "비행기"],
    clues: [
  ...
  4: {
    ...
    sns_ig: "",
    sns_etc: "https://open.kakao.com/o/aNoThErLinK",
    tags: ["신촌", "카페"],
    clues: [
  ...
  6: {
    ...
    sns_ig: "https://instagram.com/nasaearth",
    sns_etc: "",
    tags: ["부산", "해운대", "여름"],
    clues: [
...
export const MOCK_CURRENT_USER = {
  username: "김철수",
  sns_links: [
    "https://instagram.com/nasauniverse",
